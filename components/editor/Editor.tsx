...
export function Editor({roomId, currentUserType}: {roomId:string, currentUserType: UserType}) {
  ...
  return (
    ...
    <div className="editor-container size-full">
      <div className="z-50 custom-scrollbar w-screen overflow-auto border-y border-dark-300 bg-dark-100 pl-3 pr-4 shadow-sm flex min-w-full justify-between mb-10">
        <ToolbarPlugin />
